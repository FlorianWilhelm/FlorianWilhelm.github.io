...
status: published
summary: For a long time, Bayesian Hierarchical Modelling has been a very powerful tool that sadly could not be applied often due to its high com§computations in Python, Bayesian Hierarchical Modelling is now ready for prime time.  
---
