...
import pandas as pd
import pyspark
from pyspark.sql.types import MapType, StructType, ArrayType, StringType, FloatType, StructField
from pyspark.sql.functions import pandas_udf, PandasUDFType, to_json, from_json, col, concat_ws, lit
        ...
        def converter(*, cols_in=None, cols_out=None):
            ...
            def udf_wrapper(values):
                ...
                if isinstance(values, pd.DataFrame):
                    ...
                    logger.info("UDF-{} datatypes of dataframe when entering:\n{}".format(fname, values.dtypes))
                ...
                if self.function_type == PandasUDFType.GROUPED_MAP:
                    ...
                    logger.info("UDF-{} datatypes of series when leaving:\n{}".format(fname, res.dtypes))
